...
'			Me.lbShowHide.PreviewMouseMove += New DevExpress.XtraReports.UI.PreviewMouseEventHandler(Me.lbShowHide_PreviewMouseMove);
'			Me.lbShowHide.PreviewClick += New DevExpress.XtraReports.UI.PreviewMouseEventHandler(Me.lbShowHide_PreviewClick);
